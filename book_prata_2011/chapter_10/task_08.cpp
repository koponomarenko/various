...
/*
	...
	As you can see, this list really is simple;
	it doesn’t allow insertion or deletion, for example.
	...
	The usual way to handle visiting each item and performing an action 
	is to use a function that takes a function pointer as an argument:
	...
	this function to eachitem in the list. You can use the Stack class as a general guide.
*/

void DisplayItems(ListItem & Item);
...
void task_08() // let it be kind a main func
{
	...
	cout << "Display List Items: " << endl;
	List.Visit(DisplayItems);
}
