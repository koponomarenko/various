...
/*
	...
	(The nearest star after the sun is about 4.2 light years away.) Use type double(as in Listing 2.4) and this conversion factor:
	1 light year = 63,240 astronomical units
*/

inline double LightYearToAstronomical(double nLightYear)
{
	return nLightYear * 63240;
}
...
void task_06() // let it be kind a main func
{
	...
	cout<<nLightYear<<" light years = "<<LightYearToAstronomical(nLightYear)<<" astronomical units.\n";
}
